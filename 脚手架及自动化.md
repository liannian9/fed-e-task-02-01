...
### grunt的使用流程
   ...
   - js的编译转化(grunt-babel,@babel/core,@babel/preset-env)
   - html的编译转化(grunt-web-swig)（如果是模板引擎需要下载相应插件进行转化）
   - fonts(字体文件的编译与转化)(grunt-contrib-imagemin)
   - images的编译与转换压缩(grunt-contrib-imagemin)
