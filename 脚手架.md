...
### grunt的使用流程
   - sass的导出(grunt-sass, sass)

![sass](https://raw.githubusercontent.com/liannian9/Img/master/img/20200605082114.png)

   - js的导出转化(grunt-babel,@babel/core,@babel/preset-env)

![js的导出转化](https://raw.githubusercontent.com/liannian9/Img/master/img/20200605083135.png)

   - html的导出转化(grunt-web-swig)（如果是模板引擎需要下载相应插件进行转化）

![html的导出转化](https://raw.githubusercontent.com/liannian9/Img/master/img/html.jpg)

   - fonts(字体文件的导出与转化)(grunt-contrib-imagemin)
   - images的导出与转换压缩(grunt-contrib-imagemin)
...
![js的导出转化](https://raw.githubusercontent.com/liannian9/Img/master/img/js%E5%A4%84%E7%90%86.jpg)
   ...
   - html 的导出与转化 (gulp-htmlmin，gulp-swig)如果是模板引擎需要下载相应插件进行转化）
